...
public class ItmMasterFragment extends Fragment {
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_itm_master, container, false);
        ...
        myRef_detail_course = database.getReference().child("Courses").child("Master_ITM");
