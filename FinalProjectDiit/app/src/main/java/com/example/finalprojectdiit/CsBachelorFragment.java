...
public class CsBachelorFragment extends Fragment {
        ...
        TextView txtTitle, txtNameCourse1, txtNameCourse2, txtImportanceCourse, txtCreditsCourse, txtTuitionFee,
            ...
            txtTitleSpecificCourses, txtSpecificCourses, txtCareerApproach, txtCareerCourse;
    View view;
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_cs_bachelor, container, false);
        ...
        DatabaseReference myRef_detail_course = database.getReference().child("Courses").child("Bachelor_CS");
