 ...
 */
public class SmtMasterFragment extends Fragment {
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_smt_master, container, false);
        ...
        myRef_detail_course = database.getReference().child("Courses").child("Master_SMT");
