...
public class IteBachelorFragment extends Fragment {
    ...
    ImageView imageView_ITE1, imageView_ITE2;

    String image_url_ite1, image_url_ite2;
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_ite_bachelor, container, false);
        ...
        imageView_ITE1 = (ImageView) view.findViewById(R.id.imageView_ITE1);
        imageView_ITE2 = (ImageView) view.findViewById(R.id.imageView_ITE2);


        database = FirebaseDatabase.getInstance();
        myRef_detail_course = database.getReference().child("Courses").child("Bachelor_ITE");
        myRef_detail_course.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                image_url_ite1 = courses.getImg_ite1();
                image_url_ite2 = courses.getImg_ite2();

                //Set image with url
                Picasso.get().load(image_url_ite1).into(imageView_ITE1);
                Picasso.get().load(image_url_ite2).into(imageView_ITE2);
            }
