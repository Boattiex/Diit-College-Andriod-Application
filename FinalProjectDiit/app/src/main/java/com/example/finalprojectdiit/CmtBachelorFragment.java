...
public class CmtBachelorFragment extends Fragment {
    ...
    TextView txtTitle, txtNameCourse1, txtNameCourse2, txtImportanceCourse, txtCreditsCourse, txtTuitionFee,
            ...
            txtTitleSpecificCourses, txtSpecificCourses, txtCareerApproach, txtElectiveCourses;
    ...
    public View onCreateView(@Nullable LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_cmt_bachelor, container, false);
        ...
        myRef_detail_course = database.getReference().child("Courses").child("Bachelor_CMT");
